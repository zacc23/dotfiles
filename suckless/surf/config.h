...
static Parameter defconfig[ParameterLast] = {
	...
	[SmoothScrolling]     =       { { .i = 0 },     },
	[SpellChecking]       =       { { .i = 1 },     },
	[SpellLanguages]      =       { { .v = ((char *[]){ "en_US", "es_ES", NULL }) }, },
	[StrictTLS]           =       { { .i = 1 },     },
	[Style]               =       { { .i = 1 },     },
	[WebGL]               =       { { .i = 1 },     },
	[ZoomLevel]           =       { { .f = 1.0 },   },
...
static SiteSpecific styles[] = {
	...
	{ ".*duckduckgo.com/lite.*", "duck.css"      },
	{ ".*invidio.us.*",          "invidious.css" },
        { ".*instructure.com.*",     "instructure.css" },
	{ ".*lunduke.com.*",	     "blank.css"     },
	{ ".*openbsd.org.*",	     "openbsd.css"   },
	{ ".*sites.google.com/nn.k12.va.us/ikes-u-s-history.*",	"ike.css" },
	{ ".*stackexchange.com*",    "stackexchange.css" },	
	{ ".*stackoverflow.com*",    "stackexchange.css" },
	{ ".*startpage.com*",	     "startpage.css" },
	{ ".*suckless.org.*",	     "suckless.css"  },
	{ ".*superuser.com.*",       "stackexchange.css" },
	{ ".*twitch.tv.*",	     "twitch.css"    },
...
static Key keys[] = {
	...
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_Page_Down, zoom,    { .i = -1 } },
	{ MODKEY|GDK_SHIFT_MASK, GDK_KEY_Page_Up, zoom,      { .i = +1 } },
