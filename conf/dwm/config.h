...
static const char *passcmd[]  = { "dmenu_tpm", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, NULL };
static const char *surfcmd[]  = { "surf", NULL };
static const char *termcmd[]  = { "st", NULL };
static const char *tabbcmd[]  = { "tabbed", "-c", "surf", "-e", NULL};
static const char *todocmd[]  = { "todo", NULL };
static const char *wttrcmd[]  = { "xsetroot -name $(curl https://wttr.in/?format=%l:+%c+%C+%t)", NULL };
static Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,                       XK_p,      spawn,          {.v = dmenucmd } },
	{ MODKEY|ShiftMask,		XK_v,	   spawn,	   {.v = clipcmd } },
	{ MODKEY|ShiftMask,		XK_l,	   spawn,	   {.v = lockcmd } },
	{ MODKEY|ShiftMask,	        XK_a,	   spawn, 	   {.v = passcmd } },	
	{ MODKEY|ShiftMask,	        XK_s, 	   spawn,	   {.v = surfcmd } },
	{ MODKEY|ShiftMask,             XK_Return, spawn,          {.v = termcmd } },
	{ MODKEY|ShiftMask,		XK_t,	   spawn,          {.v = tabbcmd } },
